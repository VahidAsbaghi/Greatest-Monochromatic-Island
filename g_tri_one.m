...
function [I_teta,teta2]=g_tri_one(coordinates,point_num)
%% THIS FUNCTION GENERATE TRIANGULATION FOR A CHROMOSOME BY GIVING
%% COORINATES OF POINTS IN CHR. POLYSY IS BASED ON SORT POINTS IN RESPECT
%% OF FIRST POINT BY ANGLE 
